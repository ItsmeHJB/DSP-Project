    ...
    while (counter < size):
        if oo.batch_total == 0 and counter == 0:
            if oo.use_dimensional_reduction_mode:
                oo.point_select, oo.pca_distances_working_copy, this_index = select_starting_point(oo.pca_distances_working_copy)
            else:
                oo.point_select, oo.normal_distances_working_copy, this_index = select_starting_point_for_full_image(oo.normal_distances_working_copy)
            ...
            if oo.use_dimensional_reduction_mode:
                oo.point_select, oo.pca_distances_working_copy, this_index = select_point_based_on_distance(oo.point_select, oo.pca_distances_working_copy)
            else:
                oo.point_select, oo.normal_distances_working_copy, this_index = select_point_based_on_distance_for_full_image(oo.point_select, oo.normal_distances_working_copy)
            sample = 'MNIST_image_' + str(int(this_index)) + '.png'
            if sample not in oo.all_selected_filenames:
                sample_ref.append( sample )
                counter += 1
...
def getRandomTrainBatch(size):
    ...
    while (counter < size):
        if oo.batch_total == 0 and counter == 0:
            if oo.use_dimensional_reduction_mode:
                oo.point_select, oo.pca_distances_working_copy, this_index = select_starting_point(oo.pca_distances_working_copy, use_random=True)
            else:
                oo.point_select, oo.normal_distances_working_copy, this_index = select_starting_point_for_full_image(oo.normal_distances_working_copy, use_random=True)
            sample = 'MNIST_image_' + str(int(this_index)) + '.png'
            if sample not in oo.all_selected_filenames:
                sample_ref.append( sample )
                counter += 1
            ...
            if oo.use_dimensional_reduction_mode:
                oo.point_select, oo.pca_distances_working_copy, this_index = select_point_based_on_random(oo.point_select, oo.pca_distances_working_copy)
            else:
                oo.point_select, oo.normal_distances_working_copy, this_index = select_point_based_on_random_for_full_image(oo.point_select, oo.normal_distances_working_copy)
            sample = 'MNIST_image_' + str(int(this_index)) + '.png'
            if sample not in oo.all_selected_filenames:
                sample_ref.append( sample )
                counter += 1
...
def getConfidenceTrainBatch(size):
    ...
    if oo.batch_total == 0:
        ...
        while (counter < size * random_size):
            temp_point_select, temp_pca_distances_working_copy, this_index = select_point_based_on_random(temp_point_select, temp_pca_distances_working_copy)
            sample = 'MNIST_image_' + str(int(this_index)) + '.png'
            if sample not in oo.all_selected_filenames:
...
def getConfidenceDistanceTrainBatch(size):
    ...
    if oo.batch_total == 0:
        ...
        while (counter < size * distance_size):
            temp_point_select, temp_pca_distances_working_copy, this_index = select_point_based_on_distance(temp_point_select, temp_pca_distances_working_copy)
            sample = 'MNIST_image_' + str(int(this_index)) + '.png'
            if sample not in oo.all_selected_filenames:
                sample_ref_temp.append( sample )
                counter += 1
...
def add_image_to_labelling_pool():
    ...
    oo.point_select, oo.pca_distances_working_copy, this_index =  select_point(oo.point_select, oo.pca_distances_working_copy, my_index)
    output = {}
...
def train_model_using_all_methods():
    ...
    with open(oo.results_file, 'a') as the_file:
        the_file.write(str(sample_size) + "," + str(si) + "," + str(il) + "," + str(da) + "," + str(ca) + "," + user_label_counter + "\n")
    return json.dumps(output)
